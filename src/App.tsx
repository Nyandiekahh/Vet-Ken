...
import Testimonials from './components/sections/Testimonials/Testimonials'; // Import Testimonials
    ...
    <Router>
      ...
      <main>
        <Routes>
          ...
          <Route path="/testimonials" element={<Testimonials />} /> {/* Added Testimonials route */}
